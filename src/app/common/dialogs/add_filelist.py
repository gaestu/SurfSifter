"""
Dialog for adding file lists with metadata configuration.
...
class AddFileListDialog(QDialog):
    """Dialog for configuring file list metadata before import."""
    ...
    def __init__(
        ...
        Args:
            patterns: List of patterns from uploaded file
        ...
        self.setWindowTitle("Add File List")
    ...
    def _build_ui(self) -> None:
        ...
        # Info label
        info_label = QLabel(
            "Configure metadata for the file list. "
        ...
        self.category_combo.setCurrentText("Browser")  # Default
        ...
        self.description_edit.setPlaceholderText(
            "Enter a description of what this file list matches"
        )
        ...
        self.wildcard_radio.setChecked(True)  # Default
